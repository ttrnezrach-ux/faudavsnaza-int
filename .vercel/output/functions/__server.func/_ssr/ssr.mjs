...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cj0arTws.mjs");
...
var manifest = {
	"1924d10e64125cea46bacd3a1409b0ca012dc3d469fc96797e07099f8cd6cec2": {
		functionName: "recordBehavior_createServerFn_handler",
		importer: () => import("./visits-qVlazRcR.mjs")
	},
	"413702012a4684922e72665b95cb8f3dc6a549e9e0988c68a34428562d060691": {
		functionName: "getLatestLiveRun_createServerFn_handler",
		importer: () => import("./ingest-Bu2JqvVc.mjs")
	},
	"418c6550bb1d6dacfb2355adc7104d31f0fb5aed99f7b3ad67afe4aaba13ccc5": {
		functionName: "getVisitStats_createServerFn_handler",
		importer: () => import("./visits-qVlazRcR.mjs")
	},
	"42049040f4361b4245cd4607456283f9774592a24b054025ee436acaeebf9c62": {
		functionName: "runLiveIngest_createServerFn_handler",
		importer: () => import("./ingest-Bu2JqvVc.mjs")
	},
	"42a07f0e3d92bd68d28066c335325869484969eca6790138a507f64289445432": {
		functionName: "recordUniqueVisit_createServerFn_handler",
		importer: () => import("./visits-qVlazRcR.mjs")
	},
	"43fe37502218b3234107fd7a03e204251002d478d9606e5a3bdf98f72a830376": {
		functionName: "getOfficeLockState_createServerFn_handler",
		importer: () => import("./office-lock-DwSVHa1e.mjs")
	},
	"705f067f2c9117d055da5505335096f3f8f911a5744fa9a064a4ded87c697a31": {
		functionName: "recordRequestVisit_createServerFn_handler",
		importer: () => import("./visits-qVlazRcR.mjs")
	},
	"934207d0f214d57393f9d9dc9117989fd2196d098401b93d939df471d71360c0": {
		functionName: "getOfficeStats_createServerFn_handler",
		importer: () => import("./visits-qVlazRcR.mjs")
	},
	"a3556e15e7eb50cb6ec926d87552b21c87d1ec7ef68df3eab6cd65351586ca99": {
		functionName: "verifyOfficeLock_createServerFn_handler",
		importer: () => import("./office-lock-DwSVHa1e.mjs")
	},
	"b623f7d635b5f9d5b37a95d1020c0f984f65c2a99ab40783659c39a5d948b097": {
		functionName: "lockOfficeSession_createServerFn_handler",
		importer: () => import("./office-lock-DwSVHa1e.mjs")
	},
	"c439fee5beda7a0c4ba45cb99d83a0543879a87a5b0d3646b68ab920190fcfda": {
		functionName: "listLiveRuns_createServerFn_handler",
		importer: () => import("./ingest-Bu2JqvVc.mjs")
	},
	"f7b9ea1d1e8fb0f0570d6e8067247e7a20eda79e16a30f3c17c5554c821ddbe3": {
		functionName: "recordClick_createServerFn_handler",
		importer: () => import("./visits-qVlazRcR.mjs")
	},
	"f9daf2261cd98122f4cd242b39ffd82d4f8b562227276340928585125aa8dc19": {
		functionName: "getPublicTraffic_createServerFn_handler",
		importer: () => import("./visits-qVlazRcR.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D9oKIoCN.mjs").then((n) => n.t),
...
//#endregion
export { getRequest as a, createServerEntry, server_default as default, getCookie as i, TSS_SERVER_FUNCTION as n, setCookie$1 as o, getServerFnById as r, ssr_exports as s, createServerFn as t };
