...
var grokOgIdentity = { "site": {
	...
	"type": "article",
	"color": "0c0d0e",
	"description": "אותה מתודולוגיה, שתי יצירות: פאודה 5 מול הסרט התיעודי נז״א. מפת שיח עולמית של צפייה, דיבור ורשתות.",
	"locales": { "en": {
		"title": "Fauda 5 vs NAZA",
		"description": "Same methodology, two works: Fauda season 5 versus the Venice documentary NAZA — a world map of the talk."
	} },
	"image": "/og.jpg"
} };
//#endregion
